            ...
            for layer_name,layer_args in zip(layer_names,args_items):
                ...
                if layer_name == 'Conv2D':
                    for key, value in layer_args.items():
                        ...
                        if key.name =="FILTERS":
                            n_filer=value
                    arch.append(to_Conv(layer_name,offset="(0,0,0)", to="(0,0,0)", width=1, height=40, depth=40, caption=" "))
...
# sh ../tikzmake.sh pyexamples/MyArchitecture ../../../../demos/DemoClassification
